...
try:
    ...
    thresholds = list(range(60, 301, 60))  # 60초부터 300초까지 60초 간격
    results = {}
    ...
    combined_not_resumed.to_csv(r"C:\\Users\\USER\\Desktop\\short_watch_not_resumed_0_600.csv", index=False, encoding="utf-8")
    combined_resumed.to_csv(r"C:\\Users\\USER\\Desktop\\short_watch_resumed_0_600.csv", index=False, encoding="utf-8")
